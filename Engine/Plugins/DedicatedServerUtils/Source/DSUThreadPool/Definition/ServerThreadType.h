...
struct DSUTHREADPOOL_API FServerThreadHandle : public TSharedFromThis<FServerThreadHandle>
{
	FServerThreadHandle() 
...
struct DSUTHREADPOOL_API FServerThreadAbandonable : FNonAbandonableTask
{
