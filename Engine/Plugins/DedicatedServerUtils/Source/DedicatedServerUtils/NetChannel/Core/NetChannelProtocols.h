...
* 定义协议
*/
DEFINITION_NETCHANNEL_PROTOCOLS(Debug,10000)
DEFINITION_NETCHANNEL_PROTOCOLS(Hello,10001)
DEFINITION_NETCHANNEL_PROTOCOLS(Challenge,10002)
DEFINITION_NETCHANNEL_PROTOCOLS(Login,10003)
DEFINITION_NETCHANNEL_PROTOCOLS(Welcom,10004)
DEFINITION_NETCHANNEL_PROTOCOLS(Join,10005)
DEFINITION_NETCHANNEL_PROTOCOLS(Failure,10006)
DEFINITION_NETCHANNEL_PROTOCOLS(Upgrade,10007)
DEFINITION_NETCHANNEL_PROTOCOLS(HeartBeat,10008)
