...
struct DSUHTTP_API FHttpActionRequest : public TSharedFromThis<FHttpActionRequest>
{
public:
	// C++
	...
	virtual void HttpRequestComplete(FHttpRequestPtr InRequest, FHttpResponsePtr InResponse, bool bConnectedSuccess);
...
protected:
	virtual void ExecutionCompleteDelegate(FHttpRequestPtr InRequest, FHttpResponsePtr InResponse, bool bConnectedSuccess);
