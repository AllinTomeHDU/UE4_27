...
class DSUHTTP_API UHttpContentObject :public UObject
{
	GENERATED_BODY()
...
struct DSUHTTP_API FHttpContentBase
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DSUHTTP_API FHttpRequest : public FHttpContentBase
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct DSUHTTP_API FHttpResponse : public FHttpContentBase
{
	GENERATED_BODY()
...
//BP
DECLARE_DYNAMIC_DELEGATE_ThreeParams(FOnRequestCompleteDelegateBP, const FHttpRequest, Request, const FHttpResponse, Response, bool, bConnectedSuccessfully);
...
USTRUCT(BlueprintType)
struct DSUHTTP_API FHttpResponseDelegateBP
{
	GENERATED_BODY()
...
struct DSUHTTP_API FHttpResponseDelegate
{
